...
public class _TextAreaCell<T where T: Equatable, T: InputTypeInitiable> : Cell<T>, UITextViewDelegate, AreaCell {
    ...
    public override func cellBecomeFirstResponder(direction fromDiretion: Direction) -> Bool {
    ...
    public override func observeValue(forKeyPath keyPath: String?, of object: AnyObject?, change: [String : AnyObject]?, context: UnsafeMutablePointer<Void>?) {
        if let obj = object, let keyPathValue = keyPath, let changeType = change?[NSKeyValueChangeKindKey] where obj === imageView && keyPathValue == "image" && changeType.uintValue == NSKeyValueChange.setting.rawValue {
            setNeedsUpdateConstraints()
    ...
    public func textViewDidBeginEditing(_ textView: UITextView) {
        ...
        formViewController()?.textInputDidBeginEditing(textInput: textView, cell: self)
    ...
    public func textViewDidEndEditing(_ textView: UITextView) {
        ...
        formViewController()?.textInputDidEndEditing(textInput: textView, cell: self)
    ...
    public func textView(_ textView: UITextView, shouldChangeTextIn range: NSRange, replacementText text: String) -> Bool {
        return formViewController()?.textInput(textInput: textView, shouldChangeCharactersInRange: range, replacementString: text, cell: self) ?? true
    }
    
    public func textViewShouldBeginEditing(_ textView: UITextView) -> Bool {
        return formViewController()?.textInputShouldBeginEditing(textInput: textView, cell: self) ?? true
    }
    
    public func textViewShouldEndEditing(_ textView: UITextView) -> Bool {
        return formViewController()?.textInputShouldEndEditing(textInput: textView, cell: self) ?? true
    }
