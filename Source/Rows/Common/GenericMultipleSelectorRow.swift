...
public class GenericMultipleSelectorRow<T: Hashable, Cell: BaseCell, VCType: TypedRowControllerType where Cell: TypedCellType, Cell.Value == Set<T>, VCType: UIViewController, VCType.RowValue == Set<T>>: Row<Set<T>, Cell>, PresenterRowType, NoValueDisplayTextConformance {
