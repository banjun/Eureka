...
public class _MultipleSelectorRow<T: Hashable, Cell: BaseCell where Cell: TypedCellType, Cell.Value == Set<T>>: GenericMultipleSelectorRow<T, Cell, MultipleSelectorViewController<T>> {
